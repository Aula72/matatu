...
<main class="form-signin w-100 m-auto">
  <form id="loginForm">
    ...
    <div class="form-floating">
      <input type="tel" class="form-control" id="phone" placeholder="07044xxxxx">
    ...
    <input type="hidden" name="" id="user_type" value="2">
    <input type="hidden" id="user_code" value="<?php echo 'MT'.uniqid()?>">
    <div class="form-floating">
    ...
    <p class="mt-5 mb-3 text-body-secondary">Already have account? <a href="/login" style="text-decoration: none;">Signin</a> here.</p>
  </form>
</main>
